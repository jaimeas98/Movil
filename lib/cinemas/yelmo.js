...
function dateOfDay(day, idx, todayStr) {
  ...
  // UTC* (ej. "02/06/2026 23:00 local" → ms del instante "23:00 UTC"), así
  // que para recuperar la fecha calendario correcta hay que leer los
  // componentes en UTC, NO en zona Madrid (eso lo desplazaría +1 día).
